...
import { Smartphone, Link as LinkIcon, Lightbulb } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative bg-gradient-to-br from-orange-50 via-purple-50 to-teal-50 py-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 mb-8">Find . Join . Enjoy</p>
          <Link href="/p-events">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-8">
            <p className="text-gray-700 leading-relaxed max-w-3xl mx-auto mb-6">
              ...
              people, or simply have a great time, we've got you covered. Our
              platform makes it easy to discover, plan, and attend events that
              align with your interests and schedule.
            </p>
