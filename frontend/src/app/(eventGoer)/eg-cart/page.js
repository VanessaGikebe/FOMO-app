        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Review Your Tickets Before You Purchase Them
            </p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="md:col-span-2 space-y-3">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 text-sm">
            ...
            <div>
              ...
              <span className="text-gray-600">
                {(Number(item.pricePerTicket) || 0).toLocaleString()}
              </span>
            </div>
          </div>
          ...
          <div className="pt-2 border-t border-gray-200">
            ...
            <span className="text-gray-900 font-bold">
              Kshs{" "}
              {(
                (Number(item.pricePerTicket) || 0) * (item.quantity || 0)
              ).toLocaleString()}
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-between items-end gap-3">
          ...
          <button
            ...
            className="bg-black text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-gray-800 transition-colors w-full flex items-center justify-center gap-1"
          >
            <ShoppingCart className="w-4 h-4" /> Delete
          </button>
        </div>
      </div>
    </div>
