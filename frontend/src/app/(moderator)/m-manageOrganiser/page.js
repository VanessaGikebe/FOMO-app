        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <header className="bg-white shadow-sm">
                <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
                    <h1 className="text-3xl font-bold text-gray-900">Moderate Organisers</h1>
                    <p className="text-gray-600 mt-1">Manage organiser accounts for verified, high-quality event publication</p>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    {allOrganisers.length === 0 ? (
                        <div className="text-center py-20 bg-white rounded-xl shadow-lg border border-gray-200">
                            ...
                            <h3 className="mt-2 text-sm font-medium text-gray-900">No organisers to moderate</h3>
