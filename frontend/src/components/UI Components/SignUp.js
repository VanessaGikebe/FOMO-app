    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-purple-50 to-teal-50 flex items-center justify-center p-4 font-sans">
      ...
      <div className="w-full max-w-sm p-6 bg-white rounded-xl border-2 border-[#FF6B35] shadow-xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className={`${inputBaseClasses} bg-white border-2 border-[#FF6B35] text-gray-900 placeholder:text-gray-500 focus:border-[#6C5CE7]`}
            />
          </div>
          ...
          <div className="space-y-2">
            <label htmlFor="label" className="text-sm font-semibold text-gray-900">
              Account Type
            </label>
            <select
              id="label"
              ...
              required
              className="mt-1 h-10 w-full rounded-md border-2 border-[#FF6B35] bg-white px-3 py-2 text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#6C5CE7] focus:border-[#6C5CE7] transition-colors"
            >
        ...
        <p className="text-gray-600 text-sm font-medium">
          ...
          <Link href="/signin" className="text-[#FF6B35] hover:text-[#E55A2B] hover:underline transition-colors">
            Sign In
          </Link>
        </p>
          </div>
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white border border-gray-300 rounded-lg text-gray-700 font-medium hover:bg-gray-50 hover:border-gray-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-sm hover:shadow-md"
          >
